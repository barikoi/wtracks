var config = {
  ...
  activities: {
    defaults: {
      ...
      "Bike (road)": {
        ...
        speedprofile: {
          method: "refspeeds",
          parameters: [[-6, 13.8888], [-4, 11.1111], [-2, 8.8888], [0, 7.5], [2, 6.1111], [4, 16 / 3.6], [6, 11 / 3.6]]
        }
      },
      "Bike (mountain)": {
        vehicle: "bike",
  ...
  maps: {
    ...
    "Barikoi Map": {
      url: "//map.barikoi.com/styles/osm-bright/{z}/{x}/{y}.png",
      options: {
        maxZoom: 25,
        attribution:
          '&copy; <a href="http://www.sigmasport.com/" target="_blank">SIGMA Sport &reg;</a> Map data <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>'
      },
      visible: true
    },
    // "Sigma Cycle": {
    ...
    */
    ...
    "EU Huts": {
      ...
      options: {
        maxZoom: 18,
        attribution:
          '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> | <a href="http://wiki.openstreetmap.org/wiki/Hiking/mri">MRI</a>'
      },
      visible: true
    },
    "FI MML": {
      url:
        "//avoin-karttakuva.maanmittauslaitos.fi/avoin/wmts/1.0.0/maastokartta/default/WGS84_Pseudo-Mercator/{z}/{y}/{x}.png",
      options: {
